...
const Partners = () => {
  return (
    ...
    >
      ...
      <div className="absolute -top-72 -right-48 w-[512px] h-[512px] md:w-[900px] md:h-[900px] opacity-40 blur-2xl">
        <Image
      ...
      <div className="absolute -bottom-1/2 right-0 rotate-45 w-[512px] h-[512px] md:w-[900px] md:h-[900px] opacity-40 blur-2xl">
        <Image
