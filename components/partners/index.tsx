...
const Partners = () => {
  return (
    <main
      id="partners"
      className="w-screen flex flex-col justify-start items-centerpx-5 md:px-10 lg:px-48 py-20"
    >
      ...
      <div className="w-full flex flex-row flex-wrap justify-center items-center mt-4">
        ...
        {partners.board_partners.map((partner, index) => (
          <div className={"w-1/2 mb-3 px-1"} key={index}>
            <a
      ...
      <div className="w-full flex flex-wrap justify-center mt-4">
        ...
        {partners.normal_partners.map((partner, index) => (
          <div className={"w-1/2 lg:w-1/3 mb-3 px-1"} key={index}>
            <a
              key={index}
