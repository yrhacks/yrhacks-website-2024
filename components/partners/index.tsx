...
const Partners = () => {
  return (
    ...
    >
      <div className="absolute top-32 lg:top-80 right-72 w-52 h-52 rounded-tr-md rounded-bl-md rounded-tl-full rounded-br-full bg-gradient-to-br from-red-700/70 to-orange-300/70 blur-[150px]" />
      <div className="absolute bottom-32 lg:bottom-16 left-0 w-48 h-48 lg:w-80 lg:h-80 rounded-tr-full rounded-bl-full rounded-tl-md rounded-br-md bg-gradient-to-tl from-red-700/50 to-pink-400/50 blur-[150px]" />
