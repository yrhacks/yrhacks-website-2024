...
const Hero = () => {
  ...
  return (
    <header className="w-screen h-screen flex flex-col justify-center items-start bg-slate-950 pt-10 px-5 md:px-10 lg:px-48">
      <div className="absolute bottom-0 left-0 w-48 h-48 lg:w-80 lg:h-80 rounded-tr-full rounded-bl-full rounded-tl-md rounded-br-md bg-rose-600/50 blur-[150px]" />
      <div className="absolute top-32 lg:top-64 right-24 w-48 h-48 lg:w-64 lg:h-64 rounded-tr-full rounded-bl-full rounded-tl-md rounded-br-md bg-blue-600/50 blur-[130px]" />
