...
const About = () => {
  return (
    ...
    >
      ...
      <p className="text-slate-50/90 text-lg font-medium mt-4 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 mt-24 gap-y-16 gap-x-5">
        <div className="w-full flex flex-col justify-start items-center">
          ...
          <p className="text-slate-50/90 tracking-wider text-lg text-center leading-6 pt-4">
        ...
        <div className="w-full flex flex-col justify-start items-center">
          <Image
            ...
            height={110}
          />
          <p className="text-slate-50/90 tracking-wider text-md md:text-lg text-center leading-6 pt-4">
